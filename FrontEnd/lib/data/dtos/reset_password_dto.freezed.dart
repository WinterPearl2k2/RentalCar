...
class _$ResetPasswordDtoImpl implements _ResetPasswordDto {
  const _$ResetPasswordDtoImpl({this.password = '', this.email = ''});
  ...
  @override
  String toString() {
    return 'ResetPasswordDto(password: $password, email: $email)';
  }
...
abstract class _ResetPasswordDto implements ResetPasswordDto {
  const factory _ResetPasswordDto({final String password, final String email}) =
